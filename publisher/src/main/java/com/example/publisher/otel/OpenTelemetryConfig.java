package com.example.publisher.otel;

import com.example.publisher.PublisherController;
...
public class OpenTelemetryConfig {
  ...
  public Tracer initTracer(@Autowired OpenTelemetry openTelemetry) {
    return openTelemetry.getTracer(PublisherController.class.getCanonicalName());
  }
    ...
    //if (isZipkinUp()) {
      ...
      ZipkinSpanExporter zipkinExporter =
          ZipkinSpanExporter.builder()
              ...
              .setServiceName(PublisherController.class.getName())
              .build();
